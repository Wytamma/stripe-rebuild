...
<div class="text-sm ">
    <div class="pb-4"> 
        <div class="flex text-indigo font-bold p-1">
        <div class='mr-3'>
        ...
        <div class="flex p-1 text-grey-darker hover:text-grey-dark">
        <div class='mr-3'>
    ...
    <div class="pb-4">
        <div class="flex p-1 text-grey-darker hover:text-grey-dark">
        <div class='mr-3'>
            <svg class="fill-current inline-block h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
        ...
        <div class="flex p-1 text-grey-darker hover:text-grey-dark">
        <div class='mr-3'>
            <svg class="fill-current inline-block h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
    ...
    <div class="pb-4">
        ...
        <div class='mr-3'>
            <svg class="fill-current inline-block h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
            <path fill="currentColor" d="M257 8C120 8 9 119 9 256s111 248 248 248 248-111 248-248S394 8 257 8zm-49.5 374.8L81.8 257.1l125.7-125.7 35.2 35.4-24.2 24.2-11.1-11.1-77.2 77.2 77.2 77.2 26.6-26.6-53.1-52.9 24.4-24.4 77.2 77.2-75 75.2zm99-2.2l-35.2-35.2 24.1-24.4 11.1 11.1 77.2-77.2-77.2-77.2-26.5 26.5 53.1 52.9-24.4 24.4-77.2-77.2 75-75L432.2 255 306.5 380.6z"></path>
            </svg>
        </div>
        <div class="text-grey-darker">
            Connect
    ...
    <div class="pb-4">
        <div class="flex p-1 text-grey-darker hover:text-grey-dark">
        <div class='mr-3'>
            <svg class="fill-current inline-block h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
